    ...
    def start(self):
        ...
        for event in self.long_poll.listen():
            try:
                ...
                if 'action' in event.object and (event.object.action.get("type", "") == 'chat_kick_user'):
                    self.kick(chat_id=event.object.peer_id - 2000000000, member_id=event.object.action['member_id'])
